...
use crate::service::{self, dynamic_config, static_config, SecurityResource, ServiceState};
use alloc::sync::Arc;
...
> {
    pub(crate) service: Arc<ServiceState<Service, SecurityResource>>,
...
{
    pub(crate) fn new(service: ServiceState<Service, SecurityResource>) -> Self {
        Self {
