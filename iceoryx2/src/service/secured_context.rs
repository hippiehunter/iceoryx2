...
pub(crate) trait ErasedSecuredContext: Send + Sync {
    ...
    fn service_id(&self) -> &ServiceHash;
    ...
    fn request_mgmt_segment_handle(
        &self,
        port_id: u128,
    ) -> Result<Option<(SegmentInfo, PlatformHandle)>, IamClientError>;
...
impl TypeErasedSecuredContext {
    ...
    pub fn register_channel(
        ...
        self.inner
            .register_channel(sender_port_id, receiver_port_id, channel_size, handle)
    }
    ...
    pub fn request_channel_handle(
        ...
        self.inner
            .request_channel_handle(sender_port_id, receiver_port_id)
    }
    ...
    pub fn register_mgmt_segment(
        ...
        self.inner.register_mgmt_segment(port_id, mgmt_size, handle)
    }
    ...
    pub fn request_mgmt_segment_handle(
        ...
        self.inner.request_mgmt_segment_handle(port_id)
    }
...
impl<C: CalClient> SecuredServiceContext<C> {
    ...
    #[must_use]
    pub fn new(client: IamClient<C>, service_id: ServiceHash) -> Self {
        Self {
    ...
    /// Returns the service ID this context is associated with.
    pub fn service_id(&self) -> &ServiceHash {
        &self.service_id
    }
    ...
    pub fn register_channel(
        ...
        self.client.lock().unwrap().register_channel(
            &self.service_id,
            sender_port_id,
            receiver_port_id,
            channel_size,
    ...
    pub fn request_channel_handle(
        ...
        self.client.lock().unwrap().request_channel_handle(
            &self.service_id,
            sender_port_id,
            receiver_port_id,
        )
    ...
    pub fn register_mgmt_segment(
        ...
        self.client.lock().unwrap().register_mgmt_segment(
            &self.service_id,
            port_id,
            mgmt_size,
            handle,
    ...
    pub fn request_mgmt_segment_handle(
        ...
        self.client
            .lock()
            .unwrap()
            .request_mgmt_segment_handle(&self.service_id, port_id)
    }
...
impl<C: CalClient> Abandonable for SecuredServiceContext<C> {
...
impl<C: CalClient + Send + 'static> ErasedSecuredContext for SecuredServiceContext<C> {
    ...
    fn register_channel(
        ...
        SecuredServiceContext::register_channel(
            self,
            sender_port_id,
            receiver_port_id,
            channel_size,
    ...
    fn request_channel_handle(
        ...
        SecuredServiceContext::request_channel_handle(self, sender_port_id, receiver_port_id)
    }
    ...
    fn register_mgmt_segment(
        ...
        SecuredServiceContext::register_mgmt_segment(self, port_id, mgmt_size, handle)
    }
    ...
    fn request_mgmt_segment_handle(
        ...
        SecuredServiceContext::request_mgmt_segment_handle(self, port_id)
    }
