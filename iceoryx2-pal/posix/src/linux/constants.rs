...
pub const NAME_MAX: usize = libc::NAME_MAX as _;
...
pub const SCM_CREDENTIALS: int = libc::SCM_CREDENTIALS as _;
...
pub const RLIMIT_CPU: __rlim_t = libc::RLIMIT_CPU as _;
pub const RLIMIT_FSIZE: __rlim_t = libc::RLIMIT_FSIZE as _;
pub const RLIMIT_DATA: __rlim_t = libc::RLIMIT_DATA as _;
pub const RLIMIT_STACK: __rlim_t = libc::RLIMIT_STACK as _;
pub const RLIMIT_CORE: __rlim_t = libc::RLIMIT_CORE as _;
pub const RLIMIT_RSS: __rlim_t = libc::RLIMIT_RSS as _;
pub const RLIMIT_NPROC: __rlim_t = libc::RLIMIT_NPROC as _;
pub const RLIMIT_NOFILE: __rlim_t = libc::RLIMIT_NOFILE as _;
pub const RLIMIT_MEMLOCK: __rlim_t = libc::RLIMIT_MEMLOCK as _;
pub const RLIMIT_AS: __rlim_t = libc::RLIMIT_AS as _;
pub const RLIMIT_LOCKS: __rlim_t = libc::RLIMIT_LOCKS as _;
pub const RLIMIT_SIGPENDING: __rlim_t = libc::RLIMIT_SIGPENDING as _;
pub const RLIMIT_MSGQUEUE: __rlim_t = libc::RLIMIT_MSGQUEUE as _;
pub const RLIMIT_NICE: __rlim_t = libc::RLIMIT_NICE as _;
pub const RLIMIT_RTPRIO: __rlim_t = libc::RLIMIT_RTPRIO as _;
pub const RLIMIT_RTTIME: __rlim_t = libc::RLIMIT_RTTIME as _;
